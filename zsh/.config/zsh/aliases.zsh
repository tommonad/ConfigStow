...
# List files with eza
#-------------------------------------------------------
alias ll="eza --color=always --icons=always -lagh"
...
# Python environment
#-------------------------------------------------------
alias pipinstall="$HOME/myvenv/bin/pip3 install"
...
# Weather
#-------------------------------------------------------
alias wet="curl -s https://www.wttr.in/Eupen"
alias cal="cal -3"
#-------------------------------------------------------
# Wikipedia
#-------------------------------------------------------
...
# Keyboard
#-------------------------------------------------------
alias xmod="xmodmap ~/.config/X11/xmodmap && xset r rate 300 50"
...
# Dvd's
#-------------------------------------------------------
alias pdvd="mpv dvd:// --dvd-device=/dev/sr0"
alias edvd="eject /dev/sr0"
alias idvd="eject -t /dev/sr0"

#-------------------------------------------------------
# Sxhkd
#-------------------------------------------------------
alias sxh="sxhkd -m 1 >/dev/null 2>&1 &"
# alias xbk="xbindkeys &"
