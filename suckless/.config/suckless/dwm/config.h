...
static const Layout layouts[] = {
    ...
    /* { "[\\]",	dwindle },		/1* Decreasing in size right and
       leftward *1/ */

    /* { "[D]",	deck },			/1* Master on left, slaves in
       monocle-like mode on right *1/ */
    /* { "[M]",	monocle },		/1* All windows on top of eachother *1/
     */

    /* { "|M|",	centeredmaster },		/1* Master in middle, slaves on
       sides *1/ */
...
static const Key keys[] = {
    ...
    /* { MODKEY|ShiftMask,		XK_Escape,	spawn,
       SHCMD("/home/tom/scripts/setup_monitors.sh") }, */
    /* { MODKEY,			XK_grave,	spawn,	{.v = (const
       char*[]){ "dmenuunicode", NULL } } }, */
    ...
    // {MODKEY, XK_w, spawn, {.v = (const char *[]){xbindkeys &, NULL}}},
